...
void Widget::timeoutSlot()
{
    ...
    ui->pushBtn_send->setDisabled(true);
...
void Widget::Init()
{
    ...
    if(!socketState)
    {
        ...
        {
            ChatLogInfo() << "Connect To Server OK";
            socketState = true;
        }
        else
        {
    ...
    do{
        ...
        if(status == QDialog::Accepted )
        {
            ...
            doc_widget = *loginDlg.getUserStatus() ;
            ChatLogInfo()<<"get status:"<< doc_widget ;
    ...
    if (doc_widget == 1)
    {
        ...
        ui->pushButton_appointment->show();
    ...
    {
        is_doctor_w = 0;
        ui->pushBtn_send->setEnabled(true);
        ui->pushButton_start->hide();
        ui->pushButton_search->show();
        ui->pushButton_appointment->hide();
        ui->pushButton_Pre->show();
...
void Widget::on_pushButton_appointment_clicked()
{
    appointment *page_app = new appointment;
    page_app->show();
}
