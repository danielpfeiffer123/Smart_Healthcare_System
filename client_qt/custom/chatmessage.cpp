...
ChatMessage::ChatMessage(QWidget *parent) : QWidget(parent)
{
    ...
    m_leftPixmap = QPixmap(":/src/头像/panda.jpg");
    m_rightPixmap = QPixmap(":/src/头像/icebear.jpg");

    m_loadingMovie = new QMovie(this);
    m_loadingMovie->setFileName(":/src/3.gif");
...
QSize ChatMessage::getRealString(QString src)
{
    ...
    m_lineHeight = 1.5* fm.lineSpacing();
